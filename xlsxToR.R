# Copied the functions below to get them to work. Unable to install on Windows system from github or cran 
# 2017-12 HFvE
#
# xlsxTor: https://gist.github.com/schaunwheeler/5825002
# pblapply: https://github.com/psolymos/pbapply
# dopb: https://github.com/psolymos/pbapply
